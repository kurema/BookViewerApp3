...
namespace BookViewerApp.ViewModels
{
    ...
    public class Commands
    {
        ...
        //public class PageAddCommand : ICommandEventRaiseable
        //{
        //    public event EventHandler CanExecuteChanged;
        //    public void OnCanExecuteChanged() { if (CanExecuteChanged != null) CanExecuteChanged(this, new EventArgs()); }
        ...
        //    public PageAddCommand(BookViewModel model) { this.model = model; }

        //    public bool CanExecute(object parameter)
        //    {
        //        return model.PageWithinRange(model.PageSelected + int.Parse(parameter.ToString()));
        //        //return model.PagesCount > model.PageSelected + int.Parse(parameter.ToString()) && model.PageSelected >= -int.Parse(parameter.ToString());
        //    }

        //    public void Execute(object parameter)
        //    {
        //        model.PageSelected += int.Parse(parameter.ToString());
        //    }
        //}
