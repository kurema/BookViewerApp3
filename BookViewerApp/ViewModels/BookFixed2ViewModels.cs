...
public class BookViewModel : INotifyPropertyChanged, IBookViewModel, IDisposableBasic
{
	...
	public string? HistoryToken { get => _HistoryToken; set { _HistoryToken = value; OnPropertyChanged(nameof(HistoryToken)); } }
	...
	public async Task InitializeAsync(Windows.Storage.IStorageFile value, Control? target = null)
	{
		...
		if (book is Books.IBookFixed bookf && bookf.PageCount > 0)
		{
			...
			HistoryToken = HistoryManager.AddEntry(value, bookf.ID);
		}
		this.Loading = false;
	}
...
public class Commands
{
	...
	public class ShiftSelectedBook : ICommandEventRaiseable
	{
		...
		public async void Execute(object parameter)
		{
			...
			await model.InitializeAsync(content);
		}
